...
class DecomposableConvLocal(Layer):
    ...
    def __init__(self,
                 ...
                 bias=None,
                 **kwargs):
        super(DecomposableConvLocal, self).__init__(
            trainable=trainable,
            name=name,
...
class DecomposableConvAwAdd(Layer):
    def __init__(self,
                 filters,
                 kernel_size,
                 rank=2,
                 ...
                 bias=None,
                 **kwargs):
        super(DecomposableConvAwAdd, self).__init__(
            trainable=trainable,
            name=name,
            activity_regularizer=regularizers.get(activity_regularizer),
            **kwargs)
    ...
    def call(self, inputs):
        ...
        # if self.aw_mode == "add":
        self.my_theta = tf.keras.backend.sum(aw_kbs * atten, axis=-1)
        # elif self.aw_mode == "concat":
        #     raise NotImplementedError
        # else:
        #     raise NotImplementedError(f"{self.aw_mode} not implemented for DecomposableConvAw")
        #####################################################################
...
class DecomposableConvAwSimple(Layer):
    def __init__(self,
                 filters,
                 kernel_size,
                 rank=2,
                 ...
                 bias=None,
                 **kwargs):
        super(DecomposableConvAwSimple, self).__init__(
            trainable=trainable,
            name=name,
            activity_regularizer=regularizers.get(activity_regularizer),
            **kwargs)
...
class DecomposableDenseSimple(Layer):
    ...
    def __init__(self, units,
        ...
        super(DecomposableDenseSimple, self).__init__(
    ...
    def call(self, inputs):
        ...
        self.my_theta = self.fully_local
